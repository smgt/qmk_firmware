...
[_QWERTY] = LAYOUT_plaid_grid(
    ...
    KC_LCTL, KC_RALT, KC_LALT, KC_LGUI, RAISE,   LOWER, KC_ENT,  KC_SPC,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_plaid_grid(
    ...
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_LCBR,    KC_RCBR,    KC_LBRC, KC_RBRC, KC_BSLS,
